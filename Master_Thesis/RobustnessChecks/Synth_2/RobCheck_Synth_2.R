setwd("/Users/lisafadelli/Desktop/LisaFadelli_RScript_Thesis/RobustnessChecks/Synth_2")
library(readxl)
library (dplyr)
library(tidyr)
library(Synth)
...
###DATASET_PREPARATION##############################################################################
#upload the dataset already modified from the baseline model script
...
for (region in x) {
  dataprep.out <- dataprep(
    ...
    special.predictors = list(
      list("lnGDPpc_change", 2009, "mean"),
      list("lnGDPpc_change", 2010, "mean")),
      dependent = "lnGDPpc_change",
    unit.variable = "region_no",
    unit.names.variable = "region_name",
    time.variable = "year",
...
for (region in x) {
  dataprep.out <- dataprep(
    ...
    special.predictors = list(
      list("lnGDPpc_change", 2013, "mean"),
      list("lnGDPpc_change", 2014, "mean")),
    dependent = "lnGDPpc_change",
    unit.variable = "region_no",
    unit.names.variable = "region_name",
    time.variable = "year",
...
save.image("~/Desktop/LisaFadelli_RScript_Thesis/RobustnessChecks/Synth_2/Spec2.RData")
